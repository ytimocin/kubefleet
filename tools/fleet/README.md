...
The commands are chained so a failed checksum stops before anything is installed. The checksum guards against a
corrupted or truncated download; it does not authenticate the release. Unlike the CRD bundle, these archives carry no
signature yet.
